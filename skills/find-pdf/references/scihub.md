# Sci-Hub CLI reference (find-pdf scihub mode)

Backs the **scihub** mode of [find-pdf](../SKILL.md). Canonical source: [dahliasan/scihub-pp-cli](https://github.com/dahliasan/scihub-pp-cli) (public, Apache-2.0).
