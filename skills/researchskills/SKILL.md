...
| Intent | Skill |
|--------|--------|
| Draft or revise scientific prose, IMRAD, citations in prose | `scientific-writing` |
...
1. Prefer `discover-papers` as the front door for literature search (it can offer `protocol`).
2. Do not invent a second prose skill; always `scientific-writing`.
