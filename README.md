...
**AI agent skills for scientific research workflows.** Manuscript writing and
submission, evidence-grounded literature reviews, OpenAlex discovery,
PROTOCOL.md walkthroughs, PDF finding, Zotero, and research-project operations.
Works with Claude Code, Codex, Cursor, and any Agent Skills host.
...
3. Try **manuscript submission**: ask `/manuscript-submission` to inspect a target journal or run preflight.
